...
- **TestProgram.py** – Static batch test that simulates classification on predefined datasets and outputs results to files.  
- **TestProgramDynamic.py** – Interactive runtime simulation allowing user input for real-time text classification (stop words removed).
